      ...
      $('.form-type-managed-file a.dropbox-chooser', context).unbind().click(function(e) {
        ...
        Dropbox.choose({
          success: function(files) {
            ...
            $parent.find('.file-chooser-field-wrapper input[type=hidden]', context).val(_links.join('|'));
            if (_links.length) {
        ...
        //   $('button.form-type-managed-file').removeClass('disabled');
        //   $('.form-type-managed-file').addClass('thisworks');
        // });
